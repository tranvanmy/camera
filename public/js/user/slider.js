...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__slider_Slider_vue__ = __webpack_require__(514);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__slider_Slider_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__slider_Slider_vue__);
...
new __WEBPACK_IMPORTED_MODULE_0_vue___default.a({
    template: '<Slider/>',
    components: { Slider: __WEBPACK_IMPORTED_MODULE_1__slider_Slider_vue___default.a }
}).$mount('#user-slider');
...
Component.options.__file = "resources/assets/user/slider/Slider.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-bb8786a2", Component.options)
  } else {
    hotAPI.reload("data-v-bb8786a2", Component.options)
' + '  }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vue_easy_slider__ = __webpack_require__(516);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    components: { 'slider': __WEBPACK_IMPORTED_MODULE_1_vue_easy_slider__["Slider"], 'slider-item': __WEBPACK_IMPORTED_MODULE_1_vue_easy_slider__["SliderItem"] },
                ...
                while (1) {
                    switch (_context.prev = _context.next) {
                        ...
                        case 2:
                            ...
                            return _context.abrupt('return', this.list = response.data);
...
var render = function() {
  ...
  return _c(
    ...
    _vm._l(_vm.list, function(slider, index) {
      return _c(
        "slider-item",
        { key: index, attrs: { "on-click": _vm.test } },
        [
          _c(
            "a",
            {
              staticClass: "nivo-imageLink",
              attrs: {
                href: slider.link,
                title: slider.name,
                target: "_blank",
            ...
            [
              _c("img", {
                staticStyle: { width: "796px", height: "300px" },
                attrs: {
                  src: "/" + slider.image,
                  alt: slider.name,
                  border: "0"
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-bb8786a2", module.exports)
  }
}
